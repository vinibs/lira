// TODO: Padrão de nomenclaturas: arquivos de sistema, prefixo 'app.'; Arquivos de páginas, sufixo '.page.[ext]'
...
var Core = (function(router) {
    ...
    this.importAndExec = function(routeData, getVars) {
        ...
        routeContent.appendChild(script);
        ...
        this.core.importFile(path, function(pageContent){
            ...
            if(pageContent.response === router.core.pageContents[0].content){
                ...
                if(prevScript !== null){
                    ...
                    document.head.removeChild(prevSript);
                }
...
var App = (function() {
    ...
    var start = function(){
        ...
        // Importa o HTML básico de template e executa as demais funções da rota
        core.importFile('src/app/app.body.html', function(data){
            ...
            if (routeScript === null) {
                ...
                // script.src = "/spa2/src/app/app.routes.js";
                script.setAttribute("id", "route-list");
                script.type = "text/javascript";
                document.getElementById('route-content').appendChild(script);
